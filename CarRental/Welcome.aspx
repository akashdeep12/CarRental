<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Welcome.aspx.cs" Inherits="CarRental.Welcome" %>
...
div.main{
     background-image: url("http://getwallpapers.com/wallpaper/full/a/2/b/1096788-full-size-black-car-wallpaper-1920x1080.jpg");
      ...
      <div id="login">
        ...
        <br />
            ...
            <asp:Button ID="BtnLogin" runat="server" Text="Login Here" BackColor="#00008b" BorderStyle="None" Font-Names="Yu Gothic UI" ForeColor="White" Height="28px" Width="88px" OnClick="BtnLogin_Click"  />
                    <asp:Button ID="Register" runat="server" Text="Register Here" BackColor="#00008b" BorderStyle="None" Font-Names="Yu Gothic UI" ForeColor="White" Height="28px" Width="88px" OnClick="Register_Click1"  />
